...
export default function Sidebar() {
  ...
  return (
    <>
      {/* دسکتاپ */}
      <aside className="hidden md:flex fixed top-0 right-0 h-full w-[230px] bg-gradient-to-b from-orange-600/80 to-orange-500/80 backdrop:blur-2xl bg-opacity-80 shadow-lg z-[1000] flex-col pt-5 px-3">
              ...
              <li key={item.id}>
                {item.external ? (
                  <a
                    ...
                    className="flex flex-row-reverse items-center justify-end gap-2 text-white hover:text-yellow-300 hover:bg-white/10 rounded-md px-3 py-2 transition-all"
                  >
      ...
      <div className="md:hidden fixed top-0 left-0 h-full z-[9999]">
        ...
        >
          ...
          >
            <svg
              className={`w-8 h-8  text-orange-600 transition-transform duration-300 ${
                open ? "rotate-180" : ""
              }`}
              fill="none"
              stroke="currentColor"
